<x-app-layout>
    ...
    <div> <!-- Form -->
        ...
        <a href="#_" class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 bg-blue-500 rounded-full shadow-md group">
